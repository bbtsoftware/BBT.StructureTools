namespace BBT.StructureTools.Convert.Strategy
{
    ...
    /// <typeparam name="TTemporalDataType">See link above.</typeparam>
    /// <typeparam name="TConvertIntention">See link above.</typeparam>
    public interface IOperationCopyFromHist<TSource, TTarget, TSourceValue, TTemporalDataType, TConvertIntention> : IConvertOperation<TSource, TTarget>
        where TSource : class
        where TTarget : class
