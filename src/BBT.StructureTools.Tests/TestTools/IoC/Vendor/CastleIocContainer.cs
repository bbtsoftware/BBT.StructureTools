namespace BBT.StructureTools.Tests.TestTools.IoC.Vendor
{
    ...
    internal class CastleIocContainer : IIocContainer
    {
        ...
        {
            this.castleContainer.Register(Component.For<TAbstraction>().ImplementedBy<TImplementation>());
        }
        ...
        {
            this.castleContainer.Register(Component.For(abstraction).ImplementedBy(implementation));
        }
    }
}
